      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 top-full mt-3 w-[380px] max-h-[500px] overflow-hidden rounded-[20px] bg-white/10 backdrop-blur-xl border border-white/20 shadow-2xl z-50"
          >
            {/* Header */}
